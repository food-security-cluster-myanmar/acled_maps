...
#### 7.3.1 Agricultural area sown


```{r ggplotly-area-sown, fig.height = 10}

ag_map <- vulmmr %>%
  select(area_sown = all_area_sowed_mali, admin3_pcode = township_pcode, 
         township_name, state_name = state_region_name) %>%
...
#### 7.3.2 Township-level conflict map 
